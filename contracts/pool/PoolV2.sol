...
contract PoolV2 is TokenWrapper, IRewardDistributionRecipient {
    ...
    constructor(string memory name, bool _isLocked, bool _isWhitelisted, uint256 _startTime,uint256 _DURATION, uint256 _limit, address _stakeToken, address _rewardToken) ERC20Detailed(name, "POOL-V2", 18) public {
        // _name = name;
        isLocked = _isLocked;
    ...
    modifier isLimit(uint256 amount) {
        require(amount>=limit || limit==0, "POOL: You tried to stake less then minimum amount");
        _;
    }
